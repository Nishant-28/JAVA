// Write a program to create a class “mark” that stores the average mark after taking input for two subjects. Overload the post increment operator using friend function that increments the subject marks and updates the average mark. If  any subject mark is already 100 then it must not be incremented and be managed with proper exception and accordingly average mark is updated.
